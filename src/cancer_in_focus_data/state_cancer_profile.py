...
class scp_cancer_data:
    ...
    def uscs_incidence(self):
        ...
        try:
            # Locate the file
            cancer_incidence_file_finds = list(source_folder.rglob("*/*/uscs_cancer_incidence_county_2017-2021.csv"))
    ...
    def gen_single_cancer_inc(cancer_site_id: str, cancer_site: str, re_id: str, re_g: str, sex: int, folder_name: str):
        ...
        try:
            ...
            return pd.DataFrame(columns=['FIPS', 'County', 'State', 'Type', 'Site', 'RE', 'Sex', 'AAR', 'AAC'])
        
        
        fname = os.path.join(folder_name, f'incidence_us_{cancer_site_id}_{sex}_{re_id}.csv')
        try:
    ...
    def scp_cancer_mor(self):
        ...
        try:
            ...
            gen_single_cancer_mor_all = partial(self.gen_single_cancer_mor, sex='0', folder_name=self.folder_path)
            gen_single_cancer_mor_male = partial(self.gen_single_cancer_mor, sex='1', folder_name=self.folder_path)
            gen_single_cancer_mor_female = partial(self.gen_single_cancer_mor, sex='2', folder_name=self.folder_path)
...
if __name__ == "__main__":
    ...
    cancer_data_instance = scp_cancer_data(state_fips=state_fips, folder_name='cancer_data')
