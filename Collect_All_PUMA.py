...
def gen_zip_file(cancer_center_name_abb, catchment_area_df, data_dictionary):
    ...
    md.to_csv('measure_dictionary_v5.csv', encoding='utf-8', index=False)
    ...
    cdata['disp_puma'].to_csv(ca_name + '_disparity_puma_' + today + '.csv', encoding='utf-8', index=False)
    cdata['disp_puma_long'].to_csv(ca_name + '_disparity_puma_long_' + today + '.csv', encoding='utf-8', index=False)
...
if __name__ == '__main__':
    ...
    "ca_file_path": "sb_puma.csv",
    # "puma_ca_file_path": "sb_puma.csv",
    "query_level" : ['county', 'puma','tract'],
    "add_puma_level": True,
    "acs_year"    : 2023,
